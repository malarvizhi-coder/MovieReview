...
import convertMinutes from "../../src/utils/utils";
...
export const MovieDetails = () => {
  ...
  return (
    <main className="container">
      <h2 className="text-primary py-2 border-bottom mb-3">{movie.title}</h2>
      <div className="row">
        <div className="col-md-4">
          <img src={image} className="img-fluid-thumbnail"/>
        </div>
        ...
        <div className="col-md-8">
          ...
          <table className="table table-bordered w-58 mt-2">
            <tbody>
              <tr>
                <th>Runtime</th>
